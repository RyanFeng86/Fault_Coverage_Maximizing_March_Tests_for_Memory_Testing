...
#--------Unlinked Faults--------#
with open('D:\StudyFile\学习文件\Direct Research\Gupda\Group(Lei Gao, Guizhong Ye)-20210121T015144Z-001\Group(Lei Gao, Guizhong Ye)\fault_list_n_LF_space_result\fault_list_ULF2_ss.csv', 'w', newline='') as fault_list:
    csv_write = csv.writer(fault_list)
    csv_write.writerow(head)
    counter = 1
...
with open('D:\StudyFile\学习文件\Direct Research\Gupda\Group(Lei Gao, Guizhong Ye)-20210121T015144Z-001\Group(Lei Gao, Guizhong Ye)\fault_list_n_LF_space_result\fault_list_ULF2_cc.csv', 'w', newline='') as fault_list:
    csv_write = csv.writer(fault_list)
    csv_write.writerow(head)
    counter = 1
...
with open('D:\StudyFile\学习文件\Direct Research\Gupda\Group(Lei Gao, Guizhong Ye)-20210121T015144Z-001\Group(Lei Gao, Guizhong Ye)\fault_list_n_LF_space_result\fault_list_ULF3_cs.csv', 'w', newline='') as fault_list:
    csv_write = csv.writer(fault_list)
    csv_write.writerow(head)
    counter = 1
...
with open('D:\StudyFile\学习文件\Direct Research\Gupda\Group(Lei Gao, Guizhong Ye)-20210121T015144Z-001\Group(Lei Gao, Guizhong Ye)\fault_list_n_LF_space_result\fault_list_ULF3_cc.csv', 'w', newline='') as fault_list:
    csv_write = csv.writer(fault_list)
    csv_write.writerow(head)
    counter = 1
    for i in combinations_with_replacement(list(range(len(two_cell_fault))), 2):
...
with open('D:\StudyFile\学习文件\Direct Research\Gupda\Group(Lei Gao, Guizhong Ye)-20210121T015144Z-001\Group(Lei Gao, Guizhong Ye)\fault_list_n_LF_space_result\fault_list_ULF3_cc2.csv', 'w', newline='') as fault_list:
    csv_write = csv.writer(fault_list)
    csv_write.writerow(head)
    counter = 1
    for i in combinations_with_replacement(list(range(len(two_cell_fault))), 2):
