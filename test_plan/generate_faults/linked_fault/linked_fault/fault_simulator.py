...
import csv
csv_file=csv.reader(open(r'D:\StudyFile\学习文件\Direct Research\Gupda\Group(Lei Gao, Guizhong Ye)-20210121T015144Z-001\Group(Lei Gao, Guizhong Ye)\fault_list_n_LF_space_result\fault_list_LF2_av.csv','r'))
fault_list = []
temp = []
